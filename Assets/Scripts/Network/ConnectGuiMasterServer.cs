...
class ConnectGuiMasterServer : MonoBehaviour
{
    public string gameName = "Sitel Network Test";
    ...
    private bool useNat = false;		// Should the server enabled NAT punchthrough feature
    ...
    void Update()
    {
        ...
        if (doneTesting && autoConnect && !trying && Network.peerType == NetworkPeerType.Disconnected)
        {
            // Refresh hosts
